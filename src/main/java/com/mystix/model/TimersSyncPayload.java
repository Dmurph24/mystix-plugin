 ...
 * {"timers": [{timer_type, region, entity, completed_at, started_at?, crop_state?, osrs_item_id?, notifications_enabled, player_username}, ...]}
 ...
 * crop_state is optional; when present (farming patches only) it indicates growing, harvestable, etc.
 */
